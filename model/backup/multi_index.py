...
def Get_MACD(df):
    ...
    if df.iat[(dflen - 1), 7] >= df.iat[(dflen - 1), 8] >= df.iat[(dflen - 1), 9]:
        if SignalMA5[MAlen - 1] <= SignalMA10[MAlen - 1] <= SignalMA20[MAlen - 1]:
            operate -= - 1
    elif df.iat[(dflen - 1), 7] <= df.iat[(dflen - 1), 8] <= df.iat[(dflen - 1), 9]:
        if SignalMA5[MAlen - 1] >= SignalMA10[MAlen - 1] >= SignalMA20[MAlen - 1]:
            operate += 1
...
def Get_KDJ(df):
    ...
    if df.iat[(dflen - 1), 7] >= df.iat[(dflen - 1), 8] >= df.iat[(dflen - 1), 9]:
        if (slowkMA5[MAlen - 1] <= slowkMA10[MAlen - 1] <= slowkMA20[MAlen - 1]) or \
                (slowdMA5[MAlen - 1] <= slowdMA10[MAlen - 1] <= slowdMA20[MAlen - 1]):
            operate -= 1
    elif df.iat[(dflen - 1), 7] <= df.iat[(dflen - 1), 8] <= df.iat[(dflen - 1), 9]:
        if (slowkMA5[MAlen - 1] >= slowkMA10[MAlen - 1] >= slowkMA20[MAlen - 1]) or \
                (slowdMA5[MAlen - 1] >= slowdMA10[MAlen - 1] >= slowdMA20[MAlen - 1]):
